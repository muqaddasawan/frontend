              ...
              {!orders ? (
                ...
                orders.map((order, i) => (
                  ...
                  >
                    ...
                    <td className="whitespace-no-wrap px-6 text-right text-sm text-gray-600 lg:text-left">
                    ...
                    <td>
                      <Link to={`/admin/order-summary/${order._id}`}>
                        <div className="inline-flex items-center rounded-full bg-dark_gray py-2 px-3 text-xs text-white ">
                          Details
                        </div>
                      </Link>
                    </td>
